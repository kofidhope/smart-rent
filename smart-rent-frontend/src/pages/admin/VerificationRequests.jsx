...
import { CheckCircle, XCircle, Eye, User, AlertCircle } from 'lucide-react'
      ...
      <div className="page-container">
        ...
        <div className="text-center py-20">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">
            Verification service not available yet
          </h3>
          <p className="text-gray-500 text-sm max-w-md mx-auto">
            The landlord verification API is not wired on the backend.
            This page will work once `/api/verification` endpoints are added.
          </p>
        </div>
      </div>
    )
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                      {documents.map((doc) => (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="block p-3 bg-white rounded-lg border border-gray-200 hover:border-brand-green transition-colors text-center"
                        >
